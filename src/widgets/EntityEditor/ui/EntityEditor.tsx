...
import { Entity, Bestiary, Recipe, Skill, Equipment } from "../../../shared/types/entities";
...
interface EntityEditorProps {
  ...
  updateLocalizedField: (field: "name" | "description", lang: "ru" | "en", value: string) => void;
              ...
              <div className="flex-1 space-y-6 w-full">
                ...
                <div className="p-6 bg-blue-50/50 dark:bg-blue-900/10 rounded-3xl border border-blue-100 dark:border-blue-900/20">
                  <p className="text-xs font-medium text-blue-600 dark:text-blue-400 leading-relaxed">
                    💡 Best images are transparent PNGs (512x512). Uploads are automatically saved
                    to your local{" "}
              ...
              <div className="grid grid-cols-2 gap-8">
                <div className="col-span-1">
                  ...
                  <input
                    ...
                    onChange={(e) => updateField("manaCost", Number(e.target.value))}
                  />
                </div>
                <div className="col-span-1">
                  <label className="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">
                  ...
                  <input
                    ...
                    onChange={(e) => updateField("cooldown", Number(e.target.value))}
                  />
                </div>
              </div>
            )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      value={(selectedEntity as Bestiary).behavior || "aggressive"}
                    ...
                    {((selectedEntity as Bestiary).drops || []).map((drop, idx) => (
                      <div key={idx} className="flex gap-2">
                        ...
                        >
                          ...
                          {allEntities
                            .filter((x) => ["equipment", "consumables", "materials"].includes(x.category))
                            .map((x) => (
                        ...
                        <button
                          onClick={() =>
                            updateField(
                              "drops",
                              ((selectedEntity as Bestiary).drops || []).filter((_, i) => i !== idx)
                            )
                          }
